...
# -*- coding: utf-8 -*-
        ...
        ##############################################
        #   WELCOME TO THE COMMUNITY OF DARK SQUAD!! #                                      
        #   CODED BY TEAM DARK SQUAD                 #
        #   TOP CONTRIBUTERS  GUCCIFER SHUBHAM       #
        #   WEBSITE: WWW.DARKSQUAD.COM               #                       
        ##############################################
...
time.sleep(1)
print 'BAD LUCK!!,  none of the passswords in your wordlist is right.'
time.sleep(0.8)
dos.close()
os.system('rm Facebook-Log.txt || del Facebook-Log.txt')
exit()
